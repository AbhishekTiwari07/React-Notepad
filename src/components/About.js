...
const About = ()=>{
    ...
    const switchDark = ()=>{
        ...
        var state, color, backgroundColor;
        if(!style.state){
            state = 1
            color = 'white'
    ...
    return (
        ...
        <h1 className='my-3' style={style} >About me</h1>
        ...
        <button type="button" className="btn btn-dark my-3" onClick={switchDark}>{btnText}</button>
        </div>
    )
}
